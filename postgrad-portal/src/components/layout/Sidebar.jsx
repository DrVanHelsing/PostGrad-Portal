...
const NAV_ITEMS = {
  student: [
    ...
    { to: '/submissions', icon: <HiOutlineAcademicCap />, label: 'My Submissions' },
    { to: '/progress-tracker', icon: <HiOutlineClipboardDocumentList />, label: 'Progress Tracker' },
    { section: 'Resources' },
  ...
  supervisor: [
    ...
    { to: '/submissions', icon: <HiOutlineAcademicCap />, label: 'Submission Reviews' },
  ...
  coordinator: [
    ...
    { to: '/submissions', icon: <HiOutlineAcademicCap />, label: 'All Submissions' },
    { to: '/students', icon: <HiOutlineUserGroup />, label: 'Students' },
    { section: 'Committee' },
    { to: '/progress-tracker', icon: <HiOutlineChartBar />, label: 'Progress Tracker' },
  ...
  admin: [
    ...
    { to: '/roles', icon: <HiOutlineWrenchScrewdriver />, label: 'User Management' },
    { to: '/form-builder', icon: <HiOutlineWrenchScrewdriver />, label: 'Form Builder' },
    { to: '/settings', icon: <HiOutlineCog6Tooth />, label: 'Settings' },
    { to: '/help', icon: <HiOutlineQuestionMarkCircle />, label: 'Help & Docs' },
  ],
  external: [
    { section: 'Main' },
    { to: '/dashboard', icon: <HiOutlineHome />, label: 'Dashboard' },
    { to: '/requests', icon: <HiOutlineDocumentText />, label: 'My Forms' },
    { section: 'Resources' },
    { to: '/settings', icon: <HiOutlineCog6Tooth />, label: 'Settings' },
    { to: '/help', icon: <HiOutlineQuestionMarkCircle />, label: 'Help & Docs' },
  ],
